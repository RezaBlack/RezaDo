...
local function check_member_super(cb_extra, success, result)
  ...
  if success == 0 then
	send_large_msg(receiver, "Promote Me o Admin First ! ")
  end
...
local title ="+♨@SezarBT♨+\n💡 Info For SuperGroup: ["..result.title.."]\n\n"
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    return '♨@SezarBT♨:\n\nLink posting is already locked ! 🔒'
  else
    data[tostring(target)]['settings']['lock_link'] = 'yes'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nLink Posting Has Been Locked'
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nSuperGroup Spam Has Been Locked ! 🔒'
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    return '♨@SezarBT♨:\n\nSuperGroup spam is not locked !'
  else
    data[tostring(target)]['settings']['lock_spam'] = 'no'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nSuperGroup spam has been unlocked ! 🔓'
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    return '♨@SezarBT♨:\n\nArabic/Persian is already unlocked'
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'no'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nArabic/Persian has been unlocked ! 🔓'
  end
end
...
local function lock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'yes' then
    return '♨@SezarBT♨:\n\nSuperGroup Members Are already locked !'
  else
    data[tostring(target)]['settings']['lock_member'] = 'yes'
    save_data(_config.moderation.data, data)
  end
  return '♨@SezarBT♨:\n\nSuperGroup Members Has Been Locked ! 🔒'
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    return '♨@SezarBT♨:\n\nSuperGroup members are not locked'
  else
    data[tostring(target)]['settings']['lock_member'] = 'no'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nSuperGroup Members Has Been Unlocked ! 🔓'
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    return '♨@SezarBT♨:\n\nRTL is already unlocked'
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'no'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nRTL Has Been Unlocked ! 🔓'
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    return '♨@SezarBT♨:\n\nSticker posting is already locked'
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'yes'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nSticker Posting Has Been Locked ! 🔒'
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nSticker Posting Has Been Unlocked ! 🔓'
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    return '♨@SezarBT♨:\n\nContact posting is already locked'
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'yes'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nContact posting has been locked'
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    return '♨@SezarBT♨:\n\nContact posting is already unlocked'
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'no'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nContact posting has been unlocked'
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    return '♨@SezarBT♨:\n\nSettings are already strictly enforced !'
  else
    data[tostring(target)]['settings']['strict'] = 'yes'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nSettings will be strictly enforced !'
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    return '♨@SezarBT♨:\n\nSettings are not strictly enforced'
  else
    data[tostring(target)]['settings']['strict'] = 'no'
    save_data(_config.moderation.data, data)
    return '♨@SezarBT♨:\n\nSettings will not be strictly enforced'
  end
end
...
function get_message_callback(extra, success, result)
	...
	elseif get_cmd == "setadmin" then
		...
		if result.from.username then
			...
			text = "User [ "..user_id.." ]set as an admin"
		end
	...
	elseif get_cmd == "demoteadmin" then
		...
		if result.from.username then
			...
			text = "User [ "..user_id.." ] has been demoted from admin"
		end
